...
| **Instituicao** | Consórcio UnB / UFRR / UFAC |
| **Referencia** | FICHA_SOCIAL+NA+AMAZONIA.md |
| **Arquivo** | `POL_FICHA_SOCIAL_NA_AMAZONIA.md` |
...
**Responsável pela Análise:** Pesquisador Sênior e Analista de Dados do Projeto WTF
...
<p align="right"><i>"A terra não é um negócio, a terra é a noss
```
