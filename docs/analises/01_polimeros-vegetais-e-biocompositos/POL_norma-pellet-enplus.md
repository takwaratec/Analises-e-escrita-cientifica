...
how_to_cite: >
  **— Norma Pellet ENPlus**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_norma-pellet-enplus.md
---
...
| **Data** | 2026-06-27 |
| **Metodo** | 200+ Prompts para Escrever Artigos Científicos (Cavichiolli, 2025) |
| **Arquivo** | `POL_norma-pellet-enplus.md` |
...
Manual do sistema de certificação ENplus para pellets de madeira, Parte 3, estabelecendo requisitos de qualidade e especificações
