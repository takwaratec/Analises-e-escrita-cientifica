...
how_to_cite: >
  **— Rede Inter Bambu Ratan**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_rede-inter-bambu-ratan.md
---

# — Rede Inter Bambu Ratan
...
| **Data** | 2026-06-27 |
| **Metodo** | 200+ Prompts para Escrever Artigos Científicos (Cavichiolli, 2025) |
| **Arquivo** | `POL_rede-inter-bambu-ratan.md` |
...
Relatório técnico da Rede Interinstitucional Bambu e Ratan, abordando ações de pesquisa, desenv
