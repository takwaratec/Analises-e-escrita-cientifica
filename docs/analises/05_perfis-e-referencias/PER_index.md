...
how_to_cite: >
  **— Projeto Bambu**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/05_perfis-e-referencias/PER_index.md
---
...
> Este conteúdo foi integrado ao eixo **[Tecnologia Takwara](index.md)** como parte da reorganização da pesquisa. Acesse o catálogo completo em:

→ **[Catálogo IFB — 84 Referências](catalogo-ifb-bambu.md)**

---

*Todo o material do Projeto PROGRUPOS/IFB é resultado da pesquisa de Fabio Takwara para a Tecnologia Takwara.*
