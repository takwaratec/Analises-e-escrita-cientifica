...
| Campo | Dado |
|-------|------|
| **Arquivo** | `PER_analise-vault-takwara-tech.md` |
...
- **Palavras-chave:** bambu, pu vegetal, pirolenhoso, tratamento, his, athis, geodésica, resíduo, manejo, governança
