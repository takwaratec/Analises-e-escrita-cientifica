...
> 4. Toda ficha deve conter **8 seções obrigatórias** conforme método Cavitioli (2025) — se alguma seção não puder ser preenchida por falta de acesso ao PDF, a ficha não deve ser publicada.
