...
how_to_cite: >
  Fabio Takwara. **a Técnica: Infraestrutura Verde Chapada Diamantina**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/05_perfis-e-referencias/PER_ficha-infraestrutura-verde-chapada.md
---
...
| **Instituicao** | Tecnologia Takwara |
| **Data** | 2026-06-26 |
| **Arquivo** | `PER_ficha-infraestrutura-verde-chapada.md` |
