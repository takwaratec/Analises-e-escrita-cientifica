...
how_to_cite: >
  **EW TÉCNICO: IMPERVEGº RQI 132**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_imperveg-permeabilidade-vapor.md
---
...
| Campo | Dado |
|-------|------|
| **Arquivo** | `POL_imperveg-permeabilidade-vapor.md` |
...
| Referência da amostra | Comprimento (mm) | Largura (mm) | Área (m²) | Espessura da película seca (mm) |
| :-------------------- | :--------------- | :----------- | :-------- | :------------------------------ |
| REV004A/25.1          | 102,2            | 102,1        | 0,010433  | 1,41                            |
| REV004A/25.2          | 102,3            | 102,2        | 0,010447  | 1,50                            |
| REV004A/25.3          | 102,5            | 102,3        | 0,010490  | 1,06                            |
| Média                 |                  |              |           | 1,32                            |

**Tabela 2:** Valores médios da velocidade de transmissão de vapor de água do substrato e das amostras revestidas (Substrato + “IMPERVEGº RQI 132”)

| Referência da amostra                        | Velocidade de transmissão de vapor de água, V [g/(m².d)] |
| :------------------------------------------- | :------------------------------------------------------- |
| Substrato                                    | 252
