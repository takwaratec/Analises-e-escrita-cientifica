...
how_to_cite: >
  **— XIE — Modificação Química da Madeira**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/05_perfis-e-referencias/PER_xie.md
---

# — XIE — Modificação Química da Madeira
...
O documento apresenta-se como artigo científico. artigo científico. Chemical modification has been recognized as an efficient strategy for dimensionally stabilizing wood and protecting it from environm
```
