...
referencia: FICHA_+DESMATAMENTO+E+SUSTENTABILIDADE+AMAZONIA.md
status: Consolidado
conversao_cavichiolli: 2026-07-02
how_to_cite: >
  **FICHA DESMATAMENTO E SUSTENTABILIDADE AMAZONIA**. Acervo Soberania Tecnológica, 2026. Documento técnico. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_FICHA__DESMATAMENTO_E_SUSTENTABILIDADE_AMAZONIA.md
---

# FICHA DESMATAMENTO E SUSTENTABILIDADE AMAZONIA
...
| **Instituicao** | Consórcio UnB / UFRR / UFAC |
| **Referencia** | FICHA_+DESMATAMENTO+E+SUSTENTABILIDADE+AMAZONIA.md |
| **Arquivo** | `POL_FICHA__DESMATAMENTO_E_SUSTENTABILIDADE_AMAZONIA.md` |
...
*   **Referência**: FICHA_+DESMATAMENTO+E+SUSTENTABILIDADE+AMAZONIA.md
*   **Status**: Consolidado
...
Como Pesquisador Sênior e Analista de Dados do Projeto Mulheres Que Tecem a Floresta (WTF), apresento a FICHA CIENTÍFICA ESTRUTURADA para o artigo em questão.
...
![Status: Consolidado](https://img.shields.io/badge/Status-Consolidado-brigh
```
