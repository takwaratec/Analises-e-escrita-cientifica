...
### 1.1 O projeto real (verificado externamente)

| Campo | Dado | Fonte |
|---|---|---|
| Nome | Casa da Floresta Unesp-Peabiru | Jornal da Unesp, 03/11/2025; Portal UNESP Proec |
| Inauguração | Novembro de 2025 (período da COP30) | Jornal da Unesp |
| Local | Acará, PA — margens do rio Guamá | Jornal da Unesp |
| Arquiteta | **Juliana Cortez** — docente UNESP Itapeva, presidente da BambuBR | Jornal da Unesp; **Chat BambuBR L6426** (Cláudia refere "nossa presidente") |
| Parceiros | UNESP (Proec) + Instituto Peabiru + 30+ instituições | Jornal da Unesp |
| Estrutura | Cúpula geodésica em bambu + palha de buçu | Jornal da Unesp |
| Participação BambuBR | Espaço cedido em evento paralelo da UNESP/Peabiru | **Chat BambuBR L6728** (Juliana: "a UNESP está participando com o Instituto Peabiru") |

### 1.2 O texto de Fabio Takwara (advocacy)

| Campo | Dado |
|---|---|
| Autoria | **Fabio Takwara** |
| Natureza | Sátira técnica / peça de advocacy |
| Propósito | Demonstrar, por contraste irônico, o protocolo de tratamento limpo que o projeto deveria ter adotado |
| Destinatário | Presidente da BambuBR |
| Resposta | Ignorado |

## 2. Evidência Documental Primária — O Tratamento Utilizado

### 2.1 Fonte: WhatsApp BambuBR-Associados (14/10/2025)

Em meio ao debate sobre tratamentos químicos, a **própria Juliana Cortez** declarou (L6479):

> "Particularmente **sou contra o uso de CCA e CCB** no bambu e na madeira, mas enquanto a legislação brasileira ainda permitir, não temos como coibir seu uso [...]. **Utilizamos apenas octaborato de sódio**, e pelo que eu saiba o octaborato de sódio é um fertilizante. **Não usamos sulfato de cobre** no tratamento."

**Tradução do que foi dito**: O tratamento utilizado pela equipe da Casa da Floresta (e difundido pela BambuBR) é à base de **octaborato de sódio** — um composto de **boro (B)**. Embora a presidente da associação se declare "contra CCA/CCB", o método que emprega e promove utiliza **boro em altas concentrações**, cuja toxicidade carcinogênica foi comprovada pela própria UNESP (Araújo et al., 2025).

### 2.2 Fonte: WhatsApp BambuBR-Associados (14/10/2025)

Fabio Takwara denunciou a contradição (L6630):

> "A **OMISSÃO** quanto aos resultados da pesquisa sobre o **Boro como agente carcinogênico** em aparas de bambu, independente do Sulfato de Cobre, é um assunto da MAIOR importância [...]. Se esses **PILARES ÉTICOS** não forem estabelecidos, eu mesmo vou fazer uma denúncia formal à **ANVISA**, apontando a **NEGLIGÊNCIA** desta associação."

### 2.3 A remoção do grupo (fonte: _chat 5.txt, L227)

> `[19/12/2025 11:40:15] Você: +55 15 99697-6244 removeu Você`

Fabio Takwara foi **removido do grupo de WhatsApp** da BambuBR pela administradora Maristela, **sem justificativa pública**, após o acirramento do debate sobre o tratamento químico.

## 3. A Ciência que a Própria Instituição Publicou
...
**Achado central**: O tratamento com **boro** (bórax + ácido bórico) atinge **93% de Toxicidade Carcinogênica Humana (TCH)** no ciclo de vida do bambu tratado, com **91% do impacto** concentrado nos resíduos de aparas e varas descartadas.

**Paradoxo institucional**: A UNESP — mesma universidade que publicou o artigo e à qual a arquiteta/presidente é vinculada — é também a instituição que, por meio de sua docente, executou o projeto Casa da Floresta utilizando **exatamente a categoria de composto químico (boro)** cujo impacto carcinogênico seu próprio corpo científico demonstrou.

## 4. Linha do Tempo da Controvérsia (verificada)

| Data | Evento | Fonte |
|---|---|---|
| **Fev/2024** | Fabio Takwara entra na BambuBR. Hans Kleine elogia seu trabalho com PU vegetal | Chat L52-L66 |
| **18/mar/2024** | "Casa e Bambu" (Jonas) oferece bambu "tratado" — Danilo pergunta "Boro?" | Chat L301-L305 |
| **14/out/2025** | Juliana Cortez declara "utilizamos apenas octaborato de sódio" em debate com Fabio | Chat L6479 |
| **14/out/2025** | Fabio denuncia omissão sobre carcinogenicidade do boro; ameaça denúncia à ANVISA | Chat L6630 |
| **17/out/2025** | Juliana confirma participação da BambuBR na COP30 via UNESP/Peabiru | Chat L6728 |
| **Nov/2025** | Casa da Floresta inaugurada em Acará/PA durante COP30 | Jornal Unesp |
| **19/dez/2025** | Fabio é removido do grupo WhatsApp da BambuBR por Maristela | Chat5 L227 |

## 5. Análise da Contradição

| Esfera | Discurso | Prática |
|---|---|---|
| **Presidente BambuBR / Arquiteta** | "Sou contra CCA e CCB" | Utiliza octaborato de sódio (boro) |
| **UNESP (ciência)** | 93% de TCH do boro (Araújo, 2025) | Executa projeto com boro (Casa da Floresta) |
...
| Documento | Conteúdo |
|---|---|
| `_chat 5.txt` | Chat BambuBR-Associados (nov-dez/2025) — registro da remoção de Fabio |
| `WhatsApp Chat - BambuBR-Associados (1)/_chat.txt` | Chat BambuBR-Associados (fev-out/2025) — 6.744 linhas, com a declaração de Juliana (L6479) |
...
1. **Contradição científica institucional**: a UNESP publica artigo comprovando a carcinogenicidade do boro (93% TCH) enquanto uma de suas docentes utiliza o mesmo composto em projeto de "construção sustentável" na COP30
2. **Silenciamento de dissidência**: Fabio Takwara aponta a contradição com base em ciência revisada por pares e é removido do canal de relacionamento sem justificativa
3. **Vácuo regulatório**: a associação promove o octaborato de sódio como "fertilizante" — classificação que ignora os 93% de TCH demonstrados pela ACV
4. **Exemplo de sofisma institucional**: dois regimes de verdade coexistem — a ciência que se publica e a prática que se adota

5. **Consequência ambiental e territorial**: A estrutura executada consumiu centenas de quilogramas de octaborato de sódio, aplicados em bambu amazônico às margens do rio Guamá — uma área de preservação permanente em um território antes imaculado. O alerta científico quanto ao uso de técnicas ecológicas em áreas de preservação foi completamente ignorado. Como demonstrado por Araújo et al. (2025), 91% do impacto carcinogênico do tratamento com boro concentra-se nos resíduos gerados — aparas de corte, varas descartadas e solução de infiltração que, no caso da Casa da Floresta, foram gerados durante a concepção, o mutirão de construção, o período de exposição na COP30 e seguirão contaminando o solo e o lençol freático ao longo de todo o ciclo de vida da estrutura. O que foi apresentado como "vitrine de sustentabilidade" na COP da Verdade converteu-se em vetor de contaminação do berço ao túmulo — de um rio que a própria conferência prometia proteger.

6. **Colapso da soberania tecnológica**: O caso expõe um padrão estrutural de dependência. Em vez de adotar tecnologias limpas desenvolvidas nacionalmente — como o tratamento por vapor saturado (Severo & Tomaselli, 1998; Silva, 2011), o poliuretano vegetal de mamona com 15 anos de pesquisa e patentes abertas no Zenodo (Série T, T01-T12), ou o forno ecológico de ciclo fechado da Takwara — a associação e a universidade optaram por importar e consolidar um método químico ultrapassado, baseado em boro importado, cuja própria ciência nacional demonstrou ser carcinogênico. Mais grave: quando a contradição foi apontada, recorreu-se a referências extraídas de ferramentas de IA generativa sem curadoria técnica — que retornaram estudos de segurança alimentar (suplementos orais de boro para consumo humano) como se fossem aplicáveis ao tratamento industrial de bambu. Esse viés de confirmação automatizado desvaloriza a produção científica nacional, ignora a ACV publicada pela própria universidade e consolida uma dependência tecnológica que compromete a soberania do país sobre seus recursos estratégicos e a saúde de suas populações.

---

> **Nota metodológica**: Todas as afirmações sobre o tratamento utilizado baseiam-se em declaração textual da própria arquiteta/presidente (Juliana Cortez) no grupo de WhatsApp da BambuBR, registrada no arquivo `_chat.txt` L6479. O projeto Casa da Floresta foi verificado externamente via Jornal da Unesp (03/11/2025) e Portal UNESP Proec. A remoção de Fabio Takwara do grupo está registrada em `_chat 5.txt` L227.

*Ficha finalizada em 27/06/2026 · Tecnologia Takwara · Evidenciada com fontes primárias*
