...
how_to_cite: >
  Fabio Takwara. **nha: Tratamentos para Bambu — Palestra de Christian Gauss**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/02_bambu-estrutural-e-tratamentos/BAM_trATAMENTOS-christian-gauss.md
---
...
| **Autor** | Fabio Takwara |
| **Data** | 2026-06-27 |
| **Arquivo** | `BAM_trATAMENTOS-christian-gauss.md` |
...
| **Ano** | 2023 |
| **Tipo** | Palestra / Material Didático (transcrição) |
| **Promoção** | BambuBR em conjunto com PET Madeira (UNESP Itapeva) |
