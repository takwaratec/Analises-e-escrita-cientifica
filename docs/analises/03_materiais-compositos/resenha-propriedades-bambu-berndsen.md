...
| **Autor da ficha** | Fabio Takwara |
| **Data da ficha** | 2026-06-27 |
| **Licença** | CC BY 4.0 |
...
**Objetivo geral:** caracterizar anatômica, física e mecanicamente lâminas de bambu Moso (Phyllostachys pubescens) em diferentes idades (1, 3, 5 anos) e posições do colmo (base, meio, topo).

**Perguntas centrais:** como as propriedades do bambu Moso variam com a idade e posição? Qual a idade e posição ótimas para aplicações estruturais e industriais?
...
A dissertação é um dos estudos mais completos de caracterização do bambu Moso no Brasil, com análise sistemática de múltiplas propriedades em função da idade e posição. A adequação à ASTM D 143-96 confere comparabilidade internacional.

**Pontos fortes:** abordagem multiescala (anatômica, física e mecânica); faixa etária representativa (1, 3 e 5 anos); análise estatística robusta (ANOVA).

**Limitações e lacunas:** o número de colmos (12) pode ser ampliado para maior robustez estatística; não inclui análise de fadiga ou durabilidade; a adaptação da ASTM D 143-96 (norma para madeira) pode não capturar particularidades do bambu.

**Qualidade formal:** adequada.

**Relevância:** altíssima para o repositório, servindo como referência basal para propriedades do bambu Moso cultivado no Brasil.

---

## 8. INSERÇÃO NO ESTADO DA ARTE

Conecta-se com fichas sobre BLC (resenha-bambu-laminado-josericardo) e propriedades mecânicas do bambu. Classificação temática: caracterização de materiais, *Phyllostachys pubescens*, propriedades mecânicas.

**Contexto:** no Brasil, a cadeia produtiva do bambu carece de dados sistemáticos de caracterização. A dissertação de Berndsen (2008) preenche essa lacuna ao fornecer uma base de dados original para o bambu Moso cultivado no país.

**Contribuição específica:** estabelece correlações entre idade, posição no colmo e propriedades, permitindo a seleção criteriosa de matéria-prima para diferentes aplicações. O dado de densidade básica máxima (0,80 g/cm³ no topo aos 5 anos) é um parâmetro de referência.

**Lacuna identificada:** a dissertação não aborda propriedades de durabilidade natural, resistência a fungos e insetos, nem desempenho em condições de intemperismo — todas relevantes para aplicações estruturais externas.

**Conexão com a linha Tecnologia Takwara:** essencial para dimensionamento estrutural, processamento industrial e seleção de matéria-prima para produtos de bambu no âmbito do repositório técnico-científico.
...
*Documento original: resenha-propriedades-bambu-berndsen.md*
