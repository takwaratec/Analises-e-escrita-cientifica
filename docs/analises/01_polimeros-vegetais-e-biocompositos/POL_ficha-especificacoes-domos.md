...
how_to_cite: >
  Fabio Takwara. **a Técnica: Especificações Técnicas para Domos Geodésicos**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_ficha-especificacoes-domos.md
---
...
| **Instituicao** | Tecnologia Takwara |
| **Data** | 2026-06-27 |
| **Arquivo** | `POL_ficha-especificacoes-domos.md` |
