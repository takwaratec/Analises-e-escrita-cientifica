...
titulo: "Controle de Dinoderus minutus em Bambu"
tipo: Dissertação
...
| **Fonte** | Takwara-Tech (Chatbot_TK/fontes-privadas/) |
| **Arquivo Original** | D.Minutus__Besouro_do_Bambu__-_Rebeca_C_Pena__2015_Univ_S_Carlos-SP_.md |
| **Arquivo** | `POL_ficha-dminutus__besouro_do_bambu__-_rebeca_c_pena__2015_univ_s_ca.md` |
...
| Campo | Valor |
|---|---|
| **Título** | Controle de Dinoderus minutus em Bambu |
| **Tipo** | Dissertação |
...
*Extração automática — 306894 caracteres, 164 páginas.*
...
*Conteúdo completo disponível em: `PARA_REVISAO_TT/D.Minutus__Besouro_do_Bambu__-_Rebeca_C_Pena__2015_Univ_S_Carlos-SP_.md`*
...
> Link para o texto completo: `PARA_REVISAO_TT/D.Minutus__Besouro_do_Bambu__-_Rebeca_C_Pena__2015_Univ_S_Carlos-SP_.md`
...
```
# Ficha: Controle de Dinoderus minutus em Bambu
...
*Conteúdo completo disponível em: `PARA_REVISAO_TT
```
