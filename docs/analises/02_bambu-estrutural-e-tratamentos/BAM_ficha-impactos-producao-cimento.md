...
how_to_cite: >
  Fabio Takwara / Hermes Agent. **ctos da Produção de Cimento e do Concreto Armado**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/02_bambu-estrutural-e-tratamentos/BAM_ficha-impactos-producao-cimento.md
---
...
| **Fontes** | Global Carbon Project, IEA, USGS, UNEP, GCCA, Statista |
| **Data** | 29/06/2026 |
| **Arquivo** | `BAM_ficha-impactos-producao-cimento.md` |
...
- **Palavras-chave:** bambu, tratamento, certificação, resíduo, norma
