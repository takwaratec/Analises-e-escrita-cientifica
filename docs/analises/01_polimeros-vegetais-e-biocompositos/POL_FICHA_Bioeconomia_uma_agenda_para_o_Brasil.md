...
referencia: FICHA_Bioeconomia uma agenda para o Brasil.md
status: Consolidado
conversao_cavichiolli: 2026-07-02
how_to_cite: >
  **FICHA Bioeconomia uma agenda para o Brasil**. Acervo Soberania Tecnológica, 2026. Documento técnico. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_FICHA_Bioeconomia_uma_agenda_para_o_Brasil.md
---

# FICHA Bioeconomia uma agenda para o Brasil
...
| **Instituicao** | Consórcio UnB / UFRR / UFAC |
| **Referencia** | FICHA_Bioeconomia uma agenda para o Brasil.md |
| **Arquivo** | `POL_FICHA_Bioeconomia_uma_agenda_para_o_Brasil.md` |
...
- **Palavras-chave:** certificação, bioeconomia, norma, ensaio
...
![Status: Consolidado](https://img.shields.io/badge/Status-Consolidado-brightgree
```
