...
how_to_cite: >
  **— Geodésicas de Bambu (2018)**. Acervo Soberania Tecnológica, 2018. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_geodesicas-bambu.md
---

# — Geodésicas de Bambu (2018)
...
| **Data** | 2026-06-27 |
| **Metodo** | 200+ Prompts para Escrever Artigos Científicos (Cavichiolli, 2025) |
| **Arquivo** | `POL_geodesicas-bambu.md` |
...
- **Palavras-chave:** bambu, geodésica, ensaio
...
Estruturas geodésicas de bambu combinam a geometria de Fuller com as propriedades
...
O documento apresenta-se como artigo científico. artigo científico. O trabalho mostra o procedimento para construção de um domo geodésico de 4m de diâmetro usando segmentos de bam
```
