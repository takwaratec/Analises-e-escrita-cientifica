...
titulo: "Bambu Laminado Colado: Produção e Caracterização"
tipo: Dissertação
...
| **Fonte** | Takwara-Tech (Chatbot_TK/fontes-privadas/) |
| **Arquivo Original** | Filho_-_2018_-_BAMBU_LAMINADO_COLADO_PRODUC_A_O__CARACTERIZAC_A_O_E_.md |
| **Arquivo** | `POL_ficha-filho_-_2018_-_bambu_laminado_colado_produc_a_o__caracteriza.md` |
...
| Campo | Valor |
|---|---|
| **Título** | Bambu Laminado Colado: Produção e Caracterização |
| **Tipo** | Dissertação |
...
*Extração automática — 188718 caracteres, 109 páginas.*
...
*Conteúdo completo disponível em: `PARA_REVISAO_TT/Filho_-_2018_-_BAMBU_LAMINADO_COLADO_PRODUC_A_O__CARACTERIZAC_A_O_E_.md`*
...
> Link para o texto completo: `PARA_REVISAO_TT/Filho_-_2018_-_BAMBU_LAMINADO_COLADO_PRODUC_A_O__CARACTERIZAC_A_O_E_.md`
...
```
# Ficha: Bambu Laminado Colado: Produção e Caracterização
