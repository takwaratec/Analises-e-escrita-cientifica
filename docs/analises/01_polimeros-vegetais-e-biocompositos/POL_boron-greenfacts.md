...
how_to_cite: >
  **— Boron Greenfacts — Toxicidade do Boro**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_boron-greenfacts.md
---

# — Boron Greenfacts — Toxicidade do Boro
...
| **Data** | 2026-06-27 |
| **Metodo** | 200+ Prompts para Escrever Artigos Científicos (Cavichiolli, 2025) |
| **Arquivo** | `POL_boron-greenfacts.md` |
...
- **Palavras-chave:** bambu, tratamento, his
...
This Digest is a faithful summary of the leading scientific consensus report produced in 1998 by the International Programme on Chemical Safety (IPCS): "Executive Summary of the Environmenta
