...
how_to_cite: >
  **— Nayara Lage — Mineração em São Thomé das Letras**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_nayara-lage-mineracao-stl.md
---

# — Nayara Lage — Mineração em São Thomé das Letras
...
| **Data** | 2026-06-27 |
| **Metodo** | 200+ Prompts para Escrever Artigos Científicos (Cavichiolli, 2025) |
| **Arquivo** | `POL_nayara-lage-mineracao-stl.md` |
...
Análise socioambiental da atividade minerária em São Thomé das Letras (MG), abordando impactos ambientais,
