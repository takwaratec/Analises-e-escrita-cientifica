...
| Campo | Dado |
|-------|------|
| **Arquivo** | `BAM_fao-2025-bamboo-resources-assessment.md` |
...
- **Palavras-chave:** bambu, manejo, norma
...
- **Páginas:** 50
- **Idioma:** Inglês
- **Palavras-chave:** Bambu; Sensoriamento remoto; SEPAL; FAO; Random Forest; CCDC; Inventário florestal; Recursos de bambu; Séries
...
- **Título original:** Bamboo resources assessment — A methodological approach using SEPAL
```
