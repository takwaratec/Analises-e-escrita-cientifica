...
how_to_cite: >
  **— INBAR — Padrões Internacionais de Preservação**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_inbar.md
---

# — INBAR — Padrões Internacionais de Preservação
...
O documento apresenta-se como artigo científico. artigo científico. Padrões e diretrizes internacionais para preservação de bambu estabelecidos pela INBAR, abordando métodos de tratamento, produ
```
