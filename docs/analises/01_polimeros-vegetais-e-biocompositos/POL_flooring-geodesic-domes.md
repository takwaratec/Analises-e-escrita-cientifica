...
how_to_cite: >
  **— On Potentiality of Flooring in Geodesic Domes (2019)**. , 2019. DOI: 10.1088/1757-899X/687/3/033025
---

# — On Potentiality of Flooring in Geodesic Domes (2019)
...
| **Data** | 2026-06-27 |
| **Metodo** | 200+ Prompts para Escrever Artigos Científicos (Cavichiolli, 2025) |
| **Arquivo** | `POL_flooring-geodesic-domes.md` |
...
Estruturas geodésicas de bambu combinam a geometria de Fuller com as propriedades do bambu. Domos de diferentes frequências permitem vãos livres de até 30 metros com conexões como ponto crítico
...
O documento apresenta-se como artigo científico. artigo científico. This paper discusses the potentiality and practicability of installing suspended flooring in geodesic
```
