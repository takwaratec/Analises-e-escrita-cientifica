...
how_to_cite: >
  **EW TÉCNICO: IMPERVEGº RQI 132**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_imperveg-pull-off-70.md
---
...
| Campo | Dado |
|-------|------|
| **Arquivo** | `POL_imperveg-pull-off-70.md` |
...
| Corpo de Prova | Dm (mm) | Fh (N) | fh (MPa) | Modo de Ruptura                                                                    | fh_médio (MPa) (¹) | Desvio Padrão (MPa) |
| :------------- | :------ | :----- | :------- | :--------------------------------------------------------------------------------- | :----------------- | :------------------ |
| ARGOTARAO1     | 50,0    | 2687   | 1,4      | Ruptura adesiva entre o substrato de concreto e a primeira camada do sistema       |                    |                     |
| ARGOTARAO2     | 50,2    | 2660   | 1,3      | Ruptura adesiva entre o substrato de concreto e a primeira camada do sistema       |                    |                     |
| ARGOTARAO3     | 50,2    | 2097   | 1,5      | Ruptura adesiva entre o substrato de concreto e a primeira camada do sistema       | 1,4 ± 0,3          | 0,230               |
| ARGOTARAO4     | 50,2    | 2400   | 1,2      | Ruptura adesiva entre o substrato de concreto e a primeira camada do sistema       |
