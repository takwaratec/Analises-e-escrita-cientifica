...
how_to_cite: >
  **EW TÉCNICO: IMPERVEGº RQI 132**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_imperveg-sais-descongelantes.md
---

# EW TÉCNICO: IMPERVEGº RQI 132
...
| Campo | Dado |
|-------|------|
| **Arquivo** | `POL_imperveg-sais-descongelantes.md` |
...
- **Palavras-chave:** poliuretano, norma, ensaio
...
| Corpo de Prova  | Dm (mm) | Fn (N) | fn (MPa) | Modo de Ruptura                                         | fn média (MPa) (1) | StD (MPa) |
| :-------------- | :------ | :----- | :------- | :------------------------------------------------------ | :----------------- | :-------- |
| OMHO28A/24.3.01 | 50,2    | 3044   | 1,5      | Ruptura adesiva entre o substrato e a primeira camada do sistema |                    |           |
| OMHO28A/24.3.02 | 50,1    | 2626   | 1,3      | Ruptura adesiva entre o substrato e a primeira camada do sistema |                    |           |
| OMHO28A/24.3.03 | 50,2    | 2474   | 1,3      | Ruptura adesiva entre o substrato e a primeira camada do sistema | 1,3 ± 0,3          | 0,219     |
| OMHO28A/24.3.04 | 50,1    | 1865   | 0,9      | Ruptura adesiva entre o substrato e a primeira camada do sistema |                    |           |
| OMHO28A/24.3.05 | 50,1    | 2544   | 1,3      | Ruptura adesiva entre o substrato e a primeira camada do sistema |                    |           |

*(1) A incerteza de medição expandida, apresentada de acordo com o documento ILAC-G1T7, está expressa pela incer
