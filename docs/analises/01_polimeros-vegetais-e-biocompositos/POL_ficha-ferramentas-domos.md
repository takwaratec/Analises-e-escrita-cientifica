...
how_to_cite: >
  Fabio Takwara. **a Técnica: Ferramentas de Layout para Domos Geodésicos**. Acervo Soberania Tecnológica, 2026. Disponível em: https://github.com/takwaratec/acervo-soberania-tecnologica/blob/main/docs/analises/01_polimeros-vegetais-e-biocompositos/POL_ficha-ferramentas-domos.md
---
...
| **Instituicao** | Tecnologia Takwara |
| **Data** | 2026-06-27 |
| **Arquivo** | `POL_ficha-ferramentas-domos.md` |
